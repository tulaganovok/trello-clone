  ...
  return (
    <aside className="max-md:hidden pt-22 w-80 h-screen px-8 flex flex-col">
      ...
      <div className="flex flex-col mt-6 flex-1 overflow-y-auto gap-y-2">
        <h6 className="text-xs text-muted-foreground font-semibold px-2">
          Workspaces
        </h6>
              ...
              <AccordionItem key={workspace.id} value={workspace.id}>
                <AccordionButtonTrigger asChild>
                  <div className="size-full flex items-center gap-x-2">
                    <div className="size-6 bg-primary rounded-sm font-semibold uppercase text-background flex items-center justify-center text-lg">
                      {workspace.name.at(0)}
                    </div>

                    <span className="text-neutral-700">{workspace.name}</span>
                  </div>
                </AccordionButtonTrigger>
                ...
                <AccordionContent className="flex flex-col mt-1 gap-y-1">
                  <Button
                    size={'sm'}
                    variant={'ghost'}
                    className="justify-start text-neutral-700 hover:text-neutral-700"
                  >
                    <Columns3 className="ml-8 mr-1 stroke-neutral-700" />
                    Boards
                  </Button>
                  ...
                  <Button
                    size={'sm'}
                    variant={'ghost'}
                    className="justify-start pl-12"
                  >
                    <Users className="ml-8 mr-1 stroke-neutral-700" />
                    <span className="flex-1 justify-start text-start text-neutral-700">
                      Members
                    </span>
                  ...
                  <Button
                    size={'sm'}
                    variant={'ghost'}
                    className="justify-start pl-12 text-neutral-700 hover:text-neutral-700"
                  >
                    <Settings className="ml-8 mr-1 stroke-neutral-700" />
                    Settings
                  </Button>
                </AccordionContent>
              </AccordionItem>
